...
- Ответы об университете: название и история, лицензия, адрес и филиалы,
  международное присутствие, направления и уровни образования, формы обучения,
  численность студентов, факультеты, руководство и структура, цифровые
  технологии и ИИ, финансовые показатели, конкуренты, судебные дела.
